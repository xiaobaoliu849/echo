        ...
        *,
        ...
        try:
            ...
            raise AudioOverviewServiceError(
                ...
                meta={"style": selected_style, "duration_ms": safe_duration_ms, "reason": str(exc)[:400]},
            ) from exc
        return output_path
