...
DEFAULT_SETTINGS_TEMPLATE: dict[str, Any] = {
    ...
    "default_models": {
        ...
        "Google": {"default": "gemini-3.7-flash", "available": ["gemini-3.7-flash", "gemini-3.5-flash", "gemini-3.5-transcribe", "gemini-3.5-transcribe-live", "gemini-3.1-flash-lite", "gemini-3.1-flash-live-preview", "gemini-3.5-live-translate-preview", "gemini-2.5-flash", "gemini-2.5-pro"], "enabled": ["gemini-3.7-flash", "gemini-3.5-flash", "gemini-3.5-transcribe", "gemini-3.5-transcribe-live", "gemini-3.1-flash-live-preview", "gemini-3.5-live-translate-preview"]},
