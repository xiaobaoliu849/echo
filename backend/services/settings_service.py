...
DEFAULT_SETTINGS_TEMPLATE: dict[str, Any] = {
    ...
    "default_models": {
        ...
        "Google": {"default": "gemini-2.5-flash", "available": ["gemini-3.1-flash-live-preview", "gemini-2.5-flash-native-audio-preview-12-2025", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.7-flash", "gemini-3.5-flash"], "enabled": ["gemini-3.1-flash-live-preview", "gemini-2.5-flash-native-audio-preview-12-2025", "gemini-2.5-flash", "gemini-2.5-pro"]},
        "VertexAI": {"default": "gemini-2.5-flash", "available": ["gemini-3.1-flash-live-preview", "gemini-2.5-flash-native-audio-preview-12-2025", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview", "gemini-3.5-flash"], "enabled": ["gemini-3.1-flash-live-preview", "gemini-2.5-flash-native-audio-preview-12-2025", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview"]},
