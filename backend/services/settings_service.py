...
DEFAULT_SETTINGS_TEMPLATE: dict[str, Any] = {
    ...
    "default_models": {
        ...
        "AgentPlatform": {"default": "gemini-2.5-flash", "available": ["gemini-3.8-live", "gemini-3.8-live-extended-thinking", "gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.5-flash", "gemini-live-2.5-flash-native-audio", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview"], "enabled": ["gemini-3.8-live", "gemini-3.8-live-extended-thinking", "gemini-3.8-flash", "gemini-3.7-flash", "gemini-live-2.5-flash-native-audio", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview"]},
