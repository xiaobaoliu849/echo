...
DEFAULT_SETTINGS_TEMPLATE: dict[str, Any] = {
    ...
    "default_models": {
        ...
        "VertexAI": {"default": "gemini-2.5-flash", "available": ["gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview", "gemini-3.5-flash"], "enabled": ["gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview"]},
