...
DEFAULT_SETTINGS_TEMPLATE: dict[str, Any] = {
    ...
    "default_models": {
        ...
        "DashScope": {"default": "qwen-plus", "available": ["qwen-max", "qwen-plus", "qwen-turbo", "qwen3.8-omni-flash-realtime", "qwen3.5-omni-plus-realtime", "qwen3.8-livetranslate-flash-realtime", "qwen-audio-3.1-realtime-plus"], "enabled": ["qwen-max", "qwen-plus", "qwen3.8-omni-flash-realtime", "qwen3.5-omni-plus-realtime", "qwen3.8-livetranslate-flash-realtime", "qwen-audio-3.1-realtime-plus"], "tts_default": "qwen-audio-3.1-tts-flash", "tts_available": ["qwen-audio-3.1-tts-flash", "qwen-audio-3.1-tts-next", "qwen-audio-3.0-tts-flash", "qwen-audio-3.0-tts-plus", "qwen3-tts-flash-2025-11-27"], "tts_enabled": ["qwen-audio-3.1-tts-flash", "qwen-audio-3.1-tts-next", "qwen-audio-3.0-tts-flash", "qwen-audio-3.0-tts-plus", "qwen3-tts-flash-2025-11-27"]},
        "Google": {"default": "gemini-2.5-flash", "available": ["gemini-3.8-live", "gemini-3.8-live-extended-thinking", "gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.5-flash", "gemini-3.1-flash-live-preview", "gemini-2.5-flash-native-audio-preview-12-2025", "gemini-2.5-flash", "gemini-2.5-pro"], "enabled": ["gemini-3.8-live", "gemini-3.8-live-extended-thinking", "gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.1-flash-live-preview", "gemini-2.5-flash-native-audio-preview-12-2025", "gemini-2.5-flash", "gemini-2.5-pro"]},
        "AgentPlatform": {"default": "gemini-2.5-flash", "available": ["gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.5-flash", "gemini-live-2.5-flash-native-audio", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview"], "enabled": ["gemini-3.8-flash", "gemini-3.7-flash", "gemini-live-2.5-flash-native-audio", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.5-transcribe-live", "gemini-3.5-live-translate-preview"]},
