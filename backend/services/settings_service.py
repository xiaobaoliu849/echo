...
DEFAULT_SETTINGS_TEMPLATE: dict[str, Any] = {
    ...
    "default_models": {
        ...
        "DashScope": {"default": "qwen-plus", "available": ["qwen-max", "qwen-plus", "qwen-turbo", "qwen3.8-omni-flash-realtime", "qwen3.5-omni-plus-realtime", "qwen3.8-livetranslate-flash-realtime", "qwen-audio-3.1-realtime-plus"], "enabled": ["qwen-max", "qwen-plus", "qwen3.5-omni-plus-realtime", "qwen3.8-livetranslate-flash-realtime", "qwen-audio-3.1-realtime-plus"], "tts_default": "qwen-audio-3.0-tts-flash", "tts_available": ["qwen-audio-3.0-tts-flash", "qwen-audio-3.0-tts-plus", "qwen3-tts-flash-2025-11-27"], "tts_enabled": ["qwen-audio-3.0-tts-flash", "qwen-audio-3.0-tts-plus", "qwen3-tts-flash-2025-11-27"]},
